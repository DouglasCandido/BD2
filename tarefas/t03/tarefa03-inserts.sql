...
insert into postgres.atividadesbd.departamento
...
insert into postgres.atividadesbd.funcionario
...
update postgres.atividadesbd.departamento set codGerente = 1 where sigla = 'DHC';
update postgres.atividadesbd.departamento set codGerente = 2 where sigla = 'DCT';
...
insert into postgres.atividadesbd.projeto(nome, descricao, codDepto, codResponsavel, dataInicio, dataFim)
...
insert into postgres.atividadesbd.atividade(descricao, codProjeto, dataInicio, dataFim)
